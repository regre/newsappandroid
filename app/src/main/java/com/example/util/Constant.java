...
public class Constant implements Serializable{
	...
	public  static final String SERVER_URL = "http://192.168.1.102/news_app";
	...
	public static final String SERVER_IMAGE_NEWSLIST_THUMBS="http://192.168.1.102/news_app/upload/thumbs/";
	//this is the path of uploaded image of news list
	public static final String SERVER_IMAGE_NEWSLISTDETAILS="http://192.168.1.102/news_app/upload/";
	...
	public static final String LATEST_URL = "http://192.168.1.102/news_app/api.php?latest_news=10";
	//this url gives list of category in 2nd tab
	public static final String CATEGORY_URL = "http://192.168.1.102/news_app/api.php";
	//this url gives item of specific category.
	public static final String CATEGORY_ITEM_URL = "http://192.168.1.102/news_app/api.php?cat_id=";
	//this url gives your company details
	public static final String COMPANY_DETAILS_URL = "http://192.168.1.102/news_app/api.php?apps_details";
